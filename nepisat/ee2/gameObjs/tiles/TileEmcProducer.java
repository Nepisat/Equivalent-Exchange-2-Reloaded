...
public abstract class TileEmcProducer extends TileEmc
{
	...
	{
		TileEmcProducer tile = (TileEmcProducer) worldObj.getBlockTileEntity(xCoord, yCoord, zCoord);
		
		for (int i = 0; i < 6; i++)
		{
			ForgeDirection dir = ForgeDirection.VALID_DIRECTIONS[i];
			
			TileEntity closeTileEnt = worldObj.getBlockTileEntity(xCoord + dir.offsetX, yCoord + dir.offsetY, zCoord + dir.offsetZ);
