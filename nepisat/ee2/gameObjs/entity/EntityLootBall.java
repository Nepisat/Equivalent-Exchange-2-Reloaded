...
public class EntityLootBall extends Entity
{
	...
	public void onUpdate()
	{
		...
		{/*
			if (Block.blocksList[this.worldObj.getBlockId(MathHelper.floor_double(this.posX), MathHelper.floor_double(this.posY), MathHelper.floor_double(this.posZ))].blockID==Block.lavaMoving.blockID)
			{
				this.motionY = 0.20000000298023224D;
	...
	//	if (this.onGround)
	//		f = Block.blocksList[this.worldObj.getBlockId(MathHelper.floor_double(this.posX), MathHelper.floor_double(this.boundingBox.minY) - 1, MathHelper.floor_double(this.posZ))].slipperiness * 0.98F;
