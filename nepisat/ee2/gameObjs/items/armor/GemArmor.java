package nepisat.ee2.gameObjs.items.armor;
...
{
	public GemArmor(int i,int armorType)
	{
		super(i,EnumArmorMaterial.DIAMOND, 0, armorType);
	...
	public void onArmorTickUpdate(World world, EntityPlayer player, ItemStack stack)
	{
		if (world.isRemote)
		{
			if (stack.getItem() == ObjHandler.gemChest)
			{
				...
				if ((b.equals(Block.waterStill.blockID) || b.equals(Block.waterMoving.blockID) || b.equals(Block.lavaMoving) || b.equals(Block.lavaStill)) && world.getBlockId(x, y, z)==0)
				{
	...
	public static void toggleStepAssist(ItemStack boots, EntityPlayer player)
	{
		...
		player.addChatMessage("Step Assist: " + (value ? (EnumChatFormatting.GREEN + "enabled") : (EnumChatFormatting.RED + "disabled")));
	}
	...
	public static void toggleNightVision(ItemStack helm, EntityPlayer player)
	{
		...
		player.addChatMessage("Night Vision: " + (value ? (EnumChatFormatting.GREEN + "enabled") : (EnumChatFormatting.RED + "disabled")));
	}
