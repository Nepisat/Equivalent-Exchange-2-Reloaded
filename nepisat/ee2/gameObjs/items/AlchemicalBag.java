...
import nepisat.ee2.gameObjs.items.rings.RingToggle;
	...
	public void onUpdate(ItemStack stack, World world, Entity entity, int par4, boolean par5) 
	{
		...
		else
		{
			...
			if (gemDensity != null)
			{
				...
				AlchemicalBags.set(((EntityPlayer) entity).getCommandSenderName(), (byte) stack.getItemDamage(), inv);
