...
{
	public RedKatar(int i) 
	{
		super(i,"rm_katar", (byte) 4, new String[] {"De-Foresting", "Hoe", "Shear", "Attack"});
	}
	...
	private void attackNearby(World world, ItemStack stack, EntityPlayer player, byte charge)
	{
		...
		for (EntityLiving ent : list)
		{
			...
			DamageSourceA dmg = (DamageSourceA) DamageSourceA.causePlayerDamage(player);
			float totalDmg = 15.0f;
