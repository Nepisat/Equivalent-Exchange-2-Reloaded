				...
				for (k = 0; k < 16; ++k)
					if (i == 0 || i == 16 - 1 || j == 0 || j == 16 - 1 || k == 0 || k == 16 - 1)
					{
						...
						for (float f2 = 0.3F; f1 > 0.0F; f1 -= f2 * 0.75F)
						{
							...
							Block block = Block.blocksList[this.worldObj.getBlockId(j1, k1, l1)];

							if (block.blockMaterial != Material.air)
							{
								float f3 = this.exploder != null ? this.exploder.getBlockExplosionResistance(this, this.worldObj, j1, k1, l1, block) : block.getExplosionResistance(this.exploder, worldObj, j1, k1, l1, explosionX, explosionY, explosionZ);
								f1 -= (f3 + 0.3F) * f2;
							}

							if (f1 > 0.0F && (this.exploder == null || this.exploder.shouldExplodeBlock(this, this.worldObj, j1, k1, l1, block.blockID, f1)))
	...
	public void doExplosionB(boolean spawnParticles)
	{
		...
		if (this.isSmoking)
		{
			...
			while (iterator.hasNext())
			{
				...
				j = chunkposition.y;
				k = chunkposition.z;
				block = Block.blocksList[worldObj.getBlockId(i, j, k)]
						;
				...
				if (block.blockMaterial != Material.air)
				{
					ArrayList<ItemStack> drops = block.getBlockDropped(worldObj, (int) this.explosionX, (int) this.explosionY, (int) this.explosionZ, worldObj.getBlockMetadata((int) this.explosionX, (int) this.explosionY, (int) this.explosionZ), 0);
