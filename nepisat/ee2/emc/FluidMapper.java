...
public final class FluidMapper
{
	...
	private static void lazyInit()
	{
		...
		if (Utils.doesBlockHaveEmc(Block.obsidian))
		{
			addManualRegistration("obsidian.molten", Utils.getEmcValue(Block.obsidian));
		}

		if (Utils.doesBlockHaveEmc(Block.glass))
		{
			addManualRegistration("glass.molten", Utils.getEmcValue(Block.glass));
		}

		if (Utils.doesItemHaveEmc(Item.enderPearl))
		{
			addManualRegistration("ender", Utils.getEmcValue(Item.enderPearl));
		}
	}
